...
public class LoginController {
	...
	public ModelAndView Login(HttpServletRequest request,
		...
		Integer userLevel=userService.getRoleLevelByLoginName(name);
		curSession.setAttribute("role",userLevel);
		curSession.setAttribute("remark",roleService.getRoleRemarkByRoleNum(userLevel));
