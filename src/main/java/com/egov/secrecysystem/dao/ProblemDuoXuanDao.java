...
public class ProblemDuoXuanDao extends AbstractHibernateDao<SeProblemDuoXuan> {
	ProblemDuoXuanDao() {
		super(SeProblemDuoXuan.class);
	}
	...
	public List<Map> getPageInstructors(String whereString,
		...
		String hql = "select new map(t.id as id, t.problemlevel as problemlevel, t.mustright as mustright, t.keyproblem as keyproblem,"
				...
				+ "t.answer as answer,t.problemnum as problemnum) from com.egov.secrecysystem.model.SeProblemDuoXuan t";
		hql += whereString;
		hql += " order by t.id ";
	...
	public long getInstructorsTotalCount(String whereString,
		...
		String hql = "select t from com.egov.secrecysystem.model.SeProblemDuoXuan t ";
		hql += whereString;
