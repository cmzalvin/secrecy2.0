...
var passstudent = new Ext.data.Record.create([
                                          ...
                                          var passstudentstore = new Ext.data.Store( {
                                          	...
                                          	proxy : new Ext.ux.data.DWRProxy({
                                          	     dwrFunction : StudentController.getExaminerTeacher
                                          	  })
                                          });
                                    				...
                                    				//判断用户是否选中记录
                                  					if (passstudentgrid.getSelectionModel().hasSelection()) {
                                  					    ...
                                  					    var tbody=document.createElement("TBODY");  
                                  						    ...
                                  						    var text=document.createTextNode("考场号");
                                  						        td.appendChild(text);
                                  						        tr.appendChild(td);
                                  						    var td=document.createElement("TD");
                                                            ...
                                                            var td=document.createElement("TD");
                                      					    var text=document.createTextNode("语种");
                                                                ...
                                                                tr.appendChild(td);
                                                          //  var td=document.createElement("TD");
                                  						  //  var text=document.createTextNode("理论考场");
                                  						 //       td.appendChild(text);
                                                        //        tr.appendChild(td);
                                                            var td=document.createElement("TD");
                                  						...
                                  						for(var i=0;i<selections.length;i++)
                                  						{
                                  							...
                                  							tr.setAttribute('align', 'center');
                                  							var td=document.createElement("TD");
                                  						    var text=document.createTextNode(printobject.get("logicexamroomnum"));
                                  						        td.appendChild(text);
                                  						        tr.appendChild(td);
                                  						    var td=document.createElement("TD");
                                                            ...
                                                            var td=document.createElement("TD");
                                      					    ...
                                      					    var text=document.createTextNode(printobject.get("languagename"));
                                                                ...
                                                                tr.appendChild(td);
                                                         //   var td=document.createElement("TD");
                                  						 //   var text=document.createTextNode(printobject.get("theoryflag"));
                                  						  //      td.appendChild(text);
                                                           //     tr.appendChild(td);
                                                            var td=document.createElement("TD");
                                  						...
                                  						//alert(printTable);
                                  						var InfoArray=new Array("浙江省高校计算机等级考试理论监考教师名单",                             								                            								
                                  								printTable);
                                          ...
                                          function passStudentGridInit(){	
                                            	...
                                            	passstudentstore.load({
                                            		...
                                            		callback:function(records,operation,success){
                                            			if(records=="")Ext.MessageBox.alert('提示', "您还没有编排理论监考教师!");}
                                            	});
                                            }                                    


function printTheoryExaminerTeacherPageInit() {
	new Ext.Viewport( {
		layout :'border',
