...
<html>
	<head>
		...
		<script type="text/javascript" src="/SecrecySystem/resources/ext/ext-all.js"></script>
 		...
 		<script type='text/javascript' src='/SecrecySystem/dwr/interface/ModifyPasswordController.js'></script>
		<script type="text/javascript" src="/SecrecySystem/resources/custom/DwrProxy.js"></script>
		<script type="text/javascript" src="/SecrecySystem/resources/js/ModifyPassword.js"></script>
